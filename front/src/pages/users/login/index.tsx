      ...
      <div className="cont">
        <div className="inputSCT">
          ...
          <div className="contactbox">
            <p>
              ・国土交通省が進める地域交通DXプロジェクト「COMmmmONS（コモンズ）である「地域施設送迎のリソースシェア推進プロジェクト」で開発した参考画面です。{" "}
              <br />
              ・「共同送迎管理システム」は、複数の施設管理者が施設送迎（車両を用いて自施設の利用者の送迎を無償で行うもの）を共同して行うためのシステムです。{" "}
              <br />
              <br />
              <a
