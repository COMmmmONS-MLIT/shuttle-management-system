...
import { createTourismTableColumns } from "@/config/tables/visiting/TableConfig";
...
type Props = {
  ...
  >;
  visitingsCustomers: TourismVisitingsCustomer[];
  handleEdit: (customer: TourismVisitingsCustomer) => void;
  fetchVisitingsCustomers: (params: VisitingsCustomerSearchParams) => void;
  dashboard?: boolean;
  onRequestSuccess?: () => void;
};

const TourismTableList = ({
  searchParams,
  setSearchParams,
  visitingsCustomers,
  handleEdit,
...
export default TourismTableList;
