...
json.visiting do
  ...
  json.route_points @visiting.base_points.order(:order) do |point|
    ...
    passenger_count_sum = customers.map(&:passenger_count).sum
    json.passenger_count passenger_count_sum
    json.note note
    json.customers do
      json.array! customers do |customer|
        ...
        json.phone_number customer.customer.phone_number
        json.actual_time customer.formatted_actual_time
        json.schedule_time customer.formatted_schedule_time
      end
    end
  end
