...
RSpec.describe 'Tourism::VisitingsController' do
  ...
  describe 'GET /tourism/visitings' do
    subject { get tourism_visitings_path, params: }
  ...
  describe 'GET /tourism/visitings/:id' do
    subject { get tourism_visiting_path(visiting) }
  ...
  describe 'PUT /tourism/visitings/:id/update_time' do
    subject { put update_time_tourism_visiting_path(visiting), params:, as: :json }
  ...
  describe 'GET /tourism/visitings/:id/route' do
    subject { get route_tourism_visiting_path(visiting) }
  ...
  describe 'POST /tourism/visitings/new_data' do
    subject { post new_data_tourism_visitings_path, params:, as: :json }
    ...
    before do
      # DistanceServiceをモックしてGoogle APIの呼び出しを回避（Co2coモデルは削除済み、ハッシュを返す）
  ...
  describe 'DELETE /tourism/visitings/:id/remove_all_customers' do
    subject { delete remove_all_customers_tourism_visiting_path(visiting) }
    ...
    context 'when visiting does not exist' do
      it 'returns HTTP 404' do
        delete remove_all_customers_tourism_visiting_path(99_999)
  ...
  describe 'PUT /tourism/visitings/:id/update_point' do
    subject { put update_point_tourism_visiting_path(visiting), params:, as: :json }
  ...
  describe 'GET /tourism/visitings/:id/can_driving_staff' do
    subject { get can_driving_staff_tourism_visiting_path(visiting) }
  ...
  describe 'PUT /tourism/visitings/:id/update_staffs' do
    subject { put update_staffs_tourism_visiting_path(visiting), params:, as: :json }
  ...
  describe 'POST /tourism/visitings/replicate' do
    subject { post replicate_tourism_visitings_path, params:, as: :json }
  ...
  describe 'POST /tourism/visitings/replicate_with_overwrite' do
    subject { post replicate_with_overwrite_tourism_visitings_path, params:, as: :json }
  ...
  describe 'POST /tourism/visitings/share_to_office' do
    subject { post share_to_office_tourism_visitings_path, params:, as: :json }
  ...
  describe 'GET /tourism/visitings/car_index' do
    subject { get car_index_tourism_visitings_path }
  ...
  describe 'GET /tourism/visitings/visitings_customer_index' do
    subject { get visitings_customer_index_tourism_visitings_path, params: }
  ...
  describe 'GET /tourism/visitings/point_options' do
    subject { get point_options_tourism_visitings_path }
  ...
  describe 'GET /tourism/visitings/requested_soge' do
    subject { get requested_soge_tourism_visitings_path, params: }
